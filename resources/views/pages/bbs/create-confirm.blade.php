...
@section('content')
@component('components.title', [ 'title' => '掲示板 新規投稿確認' ]) @endcomponent
<div class="row py-2">
...
<form>
    ...
    <div class="text-center mt-3">
        <button type="submit" formmethod="post" formaction="create-complete" class="btn btn-outline-primary px-4">投稿</button>
        <button type="submit" formmethod="get" formaction="{{ url('bbs/create') }}" class="btn btn-outline-secondary px-4">戻る</button>
    </div>
</form>
@endsection
