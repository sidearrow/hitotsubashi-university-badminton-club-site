              ...
              <tr v-for="(season, j) in year.season" :key="i + '-' + j">
                ...
                <td>
                  <span class="text-nowrap">
                    <span v-if="season.detailIdM === null" class="mr-2">{{ season.m }}</span>
                    <router-link v-else class="mr-2" :to="'/results/league/' + season.detailIdM">{{ season.m }}</router-link>
                    <span>
                ...
                <td>
                  <span class="text-nowrap">
                    <span v-if="season.detailIdF === null" class="mr-2">{{ season.f }}</span>
                    <router-link v-else class="mr-2" :to="'/results/league/' + season.detailIdF">{{ season.f }}</router-link>
                    <span>
