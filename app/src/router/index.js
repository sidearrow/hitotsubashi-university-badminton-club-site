...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/bbs/posts/create-confirm',    component: () => import('@/pages/bbs/create-confirm') },
    { path: '/bbs/posts/create-complete',   component: () => import('@/pages/bbs/create-complete') },
    { path: '/bbs/posts/:id',               component: () => import('@/pages/bbs/posts')},
    { path: '/bbs/posts/:id/edit',          component: () => import('@/pages/bbs/edit') },
    { path: '/bbs/posts/:id/edit-confirm',  component: () => import('@/pages/bbs/edit-confirm') },
    { path: '/bbs/posts/:id/edit-complete', component: () => import('@/pages/bbs/edit-complete') },
